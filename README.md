...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/greenlearning-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12609&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/greenlearning-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `greenlearning` can be installed with:

```
conda install greenlearning
```

It is possible to list all of the versions of `greenlearning` available on your platform with:
